...
function _runWithTimeout() {
  _runWithTimeout = (0,_home_eric_HS_Coburg_HCPS_Smart_Scale_smart_scale_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (promise, time, exception) {
    let timer;
...
/* harmony import */ var _timeout__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./timeout */ 7071);
...
class BluetoothLeWeb extends _capacitor_core__WEBPACK_IMPORTED_MODULE_1__.WebPlugin {
  ...
  readRssi(_options) {
    ...
    return (0,_home_eric_HS_Coburg_HCPS_Smart_Scale_smart_scale_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      throw _this20.unavailable('readRssi is not available on web.');
    })();
  }
  ...
  read(options) {
    ...
    return (0,_home_eric_HS_Coburg_HCPS_Smart_Scale_smart_scale_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const characteristic = yield _this21.getCharacteristic(options);
  ...
  readDescriptor(options) {
    ...
    return (0,_home_eric_HS_Coburg_HCPS_Smart_Scale_smart_scale_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const descriptor = yield _this24.getDescriptor(options);
  ...
  startNotifications(options) {
    ...
    return (0,_home_eric_HS_Coburg_HCPS_Smart_Scale_smart_scale_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const characteristic = yield _this26.getCharacteristic(options);
      characteristic === null || characteristic === void 0 ? void 0 : characteristic.removeEventListener('characteristicvaluechanged', _this26.onCharacteristicValueChangedCallback);
      characteristic === null || characteristic === void 0 ? void 0 : characteristic.addEventListener('characteristicvaluechanged', _this26.onCharacteristicValueChangedCallback);

...
const routes = [
    {
        ...
        children: [
            {
                path: 'tab1',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_tab_Scale-Mode_tab1_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../tab_Scale-Mode/tab1.module */ 5289)).then(m => m.Tab1PageModule)
            },
            {
                path: 'tab2',
